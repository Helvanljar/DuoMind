...
(function () {
  ...
  const T = {
    ...
    fr: {
      ...
      login: {
        title: "Connexion",
        subtitle:
          "Accédez à vos paramètres et à l’historique.",
        email: "E-mail",
      ...
      register: {
        ...
        subtitle:
          "Le nom d’utilisateur sera visible en haut à droite.",
        username: "Nom d’utilisateur",
        email: "E-mail",
        password: "Mot de passe",
        confirm: "Confirmer le mot de passe",
        rules:
          "≥ 8 caractères, 2 chiffres, 1 caractère spécial et 1 majuscule.",
        button: "S’inscrire",
      ...
      settings: {
        title: "Paramètres",
        needlogin:
          "Connectez-vous pour modifier vos clés OpenAI / Gemini.",
        desc:
          "Ajoutez vos clés (BYOK) et le modèle préféré.",
    ...
    es: {
      ...
      home: {
        ...
        dual: "Doble LLM",
        "dual.desc":
          "Ejecuta GPT + Gemini juntos y compara.",
        byok: "BYOK",
        "byok.desc":
          "Usa tus propias claves API para mayor potencia y privacidad.",
        history: "Historial",
      ...
      register: {
        title: "Crear cuenta",
        subtitle:
          "El nombre de usuario se mostrará arriba a la derecha.",
        username: "Usuario",
        email: "Correo",
        password: "Contraseña",
        confirm: "Confirmar contraseña",
        rules:
          "≥ 8 caracteres, 2 dígitos, 1 especial y 1 mayúscula.",
        button: "Registrarse",
      ...
      settings: {
        title: "Ajustes",
        needlogin:
          "Debes iniciar sesión para editar tus claves.",
        desc:
          "Añade tus claves (BYOK) y el modelo preferido.",
      ...
      toasts: {
        ...
        invalidKeyOpenAI:
          "Clave de API de OpenAI no válida.",
        invalidKeyGemini:
          "Clave de API de Gemini no válida.",
    ...
    pt: {
      ...
      home: {
        ...
        search:
          "Peça ao DuoMind para comparar o GPT e o Gemini…",
        searchbtn: "Buscar",
        guestNote:
          "Modo convidado: 5 solicitações/dia. Adicione suas chaves para continuar sem limites.",
        dual: "LLM Duplo",
        "dual.desc":
          "Execute GPT + Gemini juntos e compare.",
        byok: "BYOK",
        "byok.desc":
          "Use suas próprias chaves API para mais potência e privacidade.",
        history: "Histórico",
        "history.desc":
          "Veja suas sessões recentes rapidamente.",
        guest: ""
      },
      login: {
        title: "Entrar",
      ...
      register: {
        title: "Criar conta",
        subtitle:
          "O nome de usuário aparecerá no canto superior direito.",
        username: "Usuário",
        email: "E-mail",
        password: "Senha",
      ...
      settings: {
        title: "Configurações",
        needlogin:
          "Faça login para editar suas chaves.",
        desc:
          "Adicione suas chaves (BYOK) e modelo preferido.",
      ...
      history: {
        ...
        needlogin:
          "É preciso entrar para ver o histórico.",
      ...
      toasts: {
        ...
        needLogin:
          "Você precisa entrar para executar esta ação.",
        invalidKeyOpenAI:
    ...
    tr: {
      ...
      home: {
        ...
        search:
          "DuoMind’dan GPT ve Gemini karşılaştırması isteyin…",
        searchbtn: "Ara",
        guestNote:
          "Misafir modu: günde 5 istek. Limitsiz devam için API anahtarınızı ekleyin.",
        dual: "Çift LLM",
        "dual.desc":
          "GPT + Gemini birlikte çalışsın, bakış açılarını karşılaştırın.",
        byok: "BYOK",
        "byok.desc":
          "Tam güç ve gizlilik için kendi API anahtarınızı kullanın.",
        history: "Geçmiş",
        "history.desc":
          "Son araştırma oturumlarınızı görün.",
        guest: ""
      },
      login: {
        title: "Giriş",
        subtitle:
          "Ayarlar ve geçmişe erişin.",
        email: "E-posta",
        password: "Şifre",
        button: "Giriş",
        noaccount:
      ...
      register: {
        title: "Hesap oluştur",
        subtitle:
          "Kullanıcı adı girişten sonra sağ üstte görünür.",
      ...
      settings: {
        title: "Ayarlar",
        needlogin:
          "OpenAI / Gemini anahtarlarını düzenlemek için giriş yapın.",
        desc:
          "Kendi anahtarlarınızı (BYOK) ekleyin ve tercih edilen modeli seçin.",
      ...
      toasts: {
        ...
        invalidKeyOpenAI:
          "Geçersiz OpenAI API anahtarı.",
        invalidKeyGemini:
          "Geçersiz Gemini API anahtarı.",
        missingKey:
          "API anahtarı eksik.",
        genericError:
    ...
    ru: {
      ...
      home: {
        ...
        search:
          "Попросите DuoMind сравнить GPT и Gemini…",
        searchbtn: "Поиск",
        guestNote:
          "Гостевой режим: 5 запросов в день. Добавьте ключи для продолжения без ограничений.",
        dual: "Двойной LLM",
        "dual.desc":
          "Запускайте GPT и Gemini вместе и сравнивайте.",
        byok: "BYOK",
        "byok.desc":
          "Используйте свои API-ключи для мощности и приватности.",
        history: "История",
        "history.desc":
          "Ваши недавние сессии исследования.",
        guest: ""
      },
      login: {
        title: "Вход",
      ...
      register: {
        ...
        subtitle:
          "Имя пользователя показывается справа вверху.",
      ...
      settings: {
        title: "Настройки",
        needlogin:
          "Войдите, чтобы редактировать ключи OpenAI / Gemini.",
        desc:
          "Добавьте ключи (BYOK) и выберите предпочитаемую модель.",
      ...
      toasts: {
        ...
        needLogin:
          "Необходимо войти в систему для выполнения действия.",
        invalidKeyOpenAI:
    ...
    ja: {
      ...
      home: {
        ...
        search:
          "GPT と Gemini を比較するよう DuoMind に依頼…",
        searchbtn: "検索",
        guestNote:
          "ゲストモード：1日5回。API キーを追加してください。",
        dual: "デュアル LLM",
        "dual.desc":
          "GPT と Gemini を同時に実行し比較します。",
        byok: "BYOK",
        "byok.desc":
          "独自の API キーでパワーとプライバシーを確保。",
        history: "履歴",
        "history.desc":
          "最近のセッションを一目で確認。",
        guest: ""
      ...
      settings: {
        title: "設定",
        needlogin:
          "OpenAI / Gemini キーを編集するにはログインしてください。",
        desc:
          "自分のキー (BYOK) と優先モデルを設定します。",
    ...
    ko: {
      ...
      home: {
        ...
        search:
          "GPT와 Gemini 비교 질문을 입력하세요…",
        searchbtn: "검색",
        guestNote:
          "게스트 모드: 하루 5회. API 키를 추가하면 제한 없이 사용 가능합니다.",
        dual: "듀얼 LLM",
        "dual.desc":
          "GPT와 Gemini를 함께 실행하고 관점을 비교하세요.",
        byok: "BYOK",
        "byok.desc":
          "자신의 API 키로 더 강력하고 안전하게.",
        history: "기록",
        "history.desc":
          "최근 연구 세션을 한눈에 확인.",
        guest: ""
      ...
      register: {
        title: "계정 만들기",
        subtitle:
          "로그인 후 사용자 이름이 오른쪽 상단에 표시됩니다.",
        username: "사용자 이름",
        email: "이메일",
        password: "비밀번호",
        confirm: "비밀번호 확인",
        rules:
          "8자 이상, 숫자 2개, 특수문자 1개, 대문자 1개 포함.",
        button: "가입",
        already:
          "이미 계정이 있나요?",
        loginlink: "로그인",
      ...
      settings: {
        title: "설정",
        needlogin:
          "OpenAI / Gemini 키를 수정하려면 로그인하세요.",
        desc:
          "자신의 키(BYOK)와 선호 LLM을 설정하세요.",
        openai: "OpenAI API 키",
        gemini: "Gemini API 키",
        preferred: "선호 LLM",
        save: "저장",
    ...
    zh: {
      ...
      home: {
        title: "欢迎使用 DuoMind",
        subtitle:
          "双 LLM 研究副驾。登录、设置密钥并开始探索。",
        search:
          "让 DuoMind 比较 GPT 和 Gemini…",
        searchbtn: "搜索",
        guestNote:
          "访客模式：每天 5 次请求。添加 API 密钥可继续无限使用。",
        dual: "双 LLM",
        "dual.desc":
          "同时运行 GPT 和 Gemini 并比较观点。",
        byok: "BYOK",
        "byok.desc":
          "使用你自己的 API 密钥，更强更私密。",
        history: "历史",
      ...
      register: {
        ...
        confirm: "确认密码",
        rules:
          "至少 8 位，包含 2 个数字、1 个特殊字符和 1 个大写字母。",
        button: "注册",
        already:
          "已有账号？",
        loginlink: "登录",
    ...
    th: {
      ...
      home: {
        ...
        subtitle:
          "โคไพลอตวิจัยแบบสอง LLM ลงชื่อเข้าใช้ ตั้งค่าคีย์ แล้วเริ่มต้นได้เลย",
        search:
          "ให้ DuoMind เปรียบเทียบ GPT กับ Gemini…",
        searchbtn: "ค้นหา",
        guestNote:
          "โหมดผู้เยี่ยมชม: วันละ 5 ครั้ง เพิ่มคีย์ API เพื่อใช้งานต่อโดยไม่จำกัด",
        dual: "LLM คู่",
        "dual.desc":
          "รัน GPT + Gemini พร้อมกันแล้วเปรียบเทียบมุมมอง",
        byok: "BYOK",
        "byok.desc":
          "ใช้คีย์ของคุณเองเพื่อพลังและความเป็นส่วนตัว",
        history: "ประวัติ",
        "history.desc":
          "ดูเซสชันวิจัยล่าสุดของคุณได้ทันที",
        guest: ""
      },
      login: {
        title: "เข้าสู่ระบบ",
        subtitle:
          "เข้าถึงการตั้งค่าและประวัติของคุณ",
        email: "อีเมล",
        password: "รหัสผ่าน",
        button: "เข้าสู่ระบบ",
        noaccount:
      ...
      register: {
        title: "สร้างบัญชี",
        subtitle:
          "ชื่อผู้ใช้จะแสดงที่มุมขวาบนหลังเข้าสู่ระบบ",
        username: "ชื่อผู้ใช้",
        email: "อีเมล",
        password: "รหัสผ่าน",
        confirm: "ยืนยันรหัสผ่าน",
        rules:
          "รหัสผ่านอย่างน้อย 8 ตัว มีตัวเลข 2 ตัว อักขระพิเศษ 1 ตัว และตัวพิมพ์ใหญ่ 1 ตัว",
        button: "สมัคร",
        already:
          "มีบัญชีอยู่แล้ว?",
      ...
      settings: {
        title: "การตั้งค่า",
        needlogin:
          "ต้องเข้าสู่ระบบเพื่อแก้ไขคีย์ OpenAI / Gemini",
        desc:
          "เพิ่มคีย์ของคุณ (BYOK) และเลือก LLM ที่ต้องการ",
      ...
      research: {
        ...
        guest:
          "โหมดผู้เยี่ยมชม: GPT-4o mini + Gemini 1.5 Flash",
        answerA: "คำตอบ (LLM A)",
        answerB: "คำตอบ (LLM B)",
      ...
      toasts: {
        ...
        needLogin:
          "ต้องเข้าสู่ระบบเพื่อดำเนินการนี้",
        invalidKeyOpenAI:
          "คีย์ API ของ OpenAI ไม่ถูกต้อง",
        invalidKeyGemini:
          "คีย์ API ของ Gemini ไม่ถูกต้อง",
        missingKey:
          "ไม่มีคีย์ API",
        genericError:
    ...
    id: {
      ...
      home: {
        ...
        subtitle:
          "Kopilot riset dengan dua LLM. Masuk, atur kunci Anda, lalu mulai.",
        search:
          "Minta DuoMind membandingkan GPT dan Gemini…",
        searchbtn: "Cari",
        guestNote:
          "Mode tamu: 5 permintaan/hari. Tambahkan kunci API untuk tanpa batas.",
        dual: "LLM Ganda",
        "dual.desc":
          "Jalankan GPT + Gemini bersama dan bandingkan sudut pandang.",
        byok: "BYOK",
        "byok.desc":
          "Gunakan kunci API sendiri demi daya dan privasi.",
        history: "Riwayat",
        "history.desc":
          "Lihat sesi riset terbaru Anda dengan cepat.",
        guest: ""
      },
      login: {
        title: "Masuk",
        subtitle:
          "Akses pengaturan dan riwayat Anda.",
        email: "Email",
        password: "Kata sandi",
        button: "Masuk",
        noaccount:
      ...
      register: {
        title: "Buat akun",
        subtitle:
          "Nama pengguna akan tampil di kanan atas setelah login.",
        username: "Nama pengguna",
        email: "Email",
        password: "Kata sandi",
        confirm: "Konfirmasi kata sandi",
        rules:
          "Minimal 8 karakter, 2 digit, 1 simbol, dan 1 huruf besar.",
        button: "Daftar",
        already:
          "Sudah punya akun?",
        loginlink: "Masuk",
      ...
      settings: {
        title: "Pengaturan",
        needlogin:
          "Masuk untuk mengedit kunci OpenAI / Gemini.",
        desc:
          "Tambahkan kunci Anda (BYOK) dan pilih LLM favorit.",
      ...
      research: {
        ...
        guest:
          "Mode tamu: GPT-4o mini + Gemini 1.5 Flash.",
    ...
    vi: {
      ...
      home: {
        ...
        subtitle:
          "Trợ lý nghiên cứu với 2 LLM. Đăng nhập, đặt khóa và bắt đầu.",
        search:
          "Yêu cầu DuoMind so sánh GPT và Gemini…",
        searchbtn: "Tìm kiếm",
        guestNote:
          "Chế độ khách: 5 lượt/ngày. Thêm khóa API để dùng không giới hạn.",
        dual: "LLM Kép",
        "dual.desc":
          "Chạy GPT + Gemini cùng lúc và so sánh.",
        byok: "BYOK",
        "byok.desc":
          "Dùng khóa API riêng để mạnh mẽ và riêng tư.",
        history: "Lịch sử",
        "history.desc":
          "Xem nhanh các phiên gần đây.",
        guest: ""
      },
      login: {
        title: "Đăng nhập",
        subtitle:
          "Truy cập cài đặt và lịch sử.",
        email: "Email",
        password: "Mật khẩu",
        button: "Đăng nhập",
        noaccount:
      ...
      register: {
        title: "Tạo tài khoản",
        subtitle:
          "Tên người dùng hiển thị ở góc phải trên sau khi đăng nhập.",
        username: "Tên người dùng",
        email: "Email",
        password: "Mật khẩu",
        confirm: "Xác nhận mật khẩu",
        rules:
          "Tối thiểu 8 ký tự, gồm 2 số, 1 ký tự đặc biệt và 1 chữ hoa.",
        button: "Đăng ký",
        already:
          "Đã có tài khoản?",
        loginlink: "Đăng nhập",
      ...
      settings: {
        title: "Cài đặt",
        needlogin:
          "Hãy đăng nhập để sửa khóa OpenAI / Gemini.",
        desc:
          "Thêm khóa (BYOK) và chọn mô hình ưa thích.",
      ...
      research: {
        ...
        guest:
          "Chế độ khách: GPT-4o mini + Gemini 1.5 Flash.",
      ...
      toasts: {
        ...
        invalidKeyOpenAI:
          "Khoá API OpenAI không hợp lệ.",
        invalidKeyGemini:
          "Khoá API Gemini không hợp lệ.",
        missingKey:
          "Thiếu khoá API.",
        genericError:
    ...
    ar: {
      ...
      home: {
        ...
        subtitle:
          "مساعد أبحاث ثنائي النماذج. سجّل الدخول وأضف مفاتيحك وابدأ.",
        search:
          "اطلب من DuoMind مقارنة GPT وGemini…",
        searchbtn: "بحث",
        guestNote:
          "وضع الزائر: 5 طلبات يوميًا. أضف مفاتيح API للمتابعة دون حدود.",
        dual: "نماذج مزدوجة",
        "dual.desc":
          "شغّل GPT وGemini معًا وقارن النتائج.",
        byok: "BYOK",
        "byok.desc":
          "استخدم مفاتيحك الخاصة لمزيد من القوة والخصوصية.",
        history: "السجل",
        "history.desc":
          "اعرض جلساتك الأخيرة بسرعة.",
        guest: ""
      },
      login: {
        title: "تسجيل الدخول",
        subtitle:
          "الوصول إلى الإعدادات والسجل.",
      ...
      register: {
        title: "إنشاء حساب",
        subtitle:
          "سيظهر اسم المستخدم في الأعلى بعد تسجيل الدخول.",
      ...
      settings: {
        title: "الإعدادات",
        needlogin:
          "يلزم تسجيل الدخول لتعديل مفاتيح OpenAI / Gemini.",
        desc:
          "أضف مفاتيحك (BYOK) واختر النموذج المفضل.",
        openai: "مفتاح OpenAI",
        gemini: "مفتاح Gemini",
      ...
      research: {
        ...
        guest:
          "وضع الزائر: GPT-4o mini + Gemini 1.5 Flash.",
        answerA: "إجابة (LLM A)",
        answerB: "إجابة (LLM B)",
  ...
  function applyTranslations(root) {
    ...
    if (dd && btn) {
      dd.textContent = btn.textContent.trim();
    }
